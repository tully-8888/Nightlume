...
Nightlume is an open source fork of [Moonlight PC](https://moonlight-stream.org), targeting high-performance game streaming on Apple Silicon Macs.

This fork focuses on Apple Silicon-oriented rendering, streaming, and latency optimizations while maintaining compatibility with Sunshine hosts and core Moonlight workflows.

Nightlume is developed with AI-assisted engineering workflows and maintained as a transparent open source project.
