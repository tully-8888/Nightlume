...
public:
    ...
    Q_PROPERTY(VsrColorMode vsrColorMode MEMBER vsrColorMode NOTIFY vsrColorModeChanged)
    Q_PROPERTY(bool detailEnabled MEMBER detailEnabled NOTIFY detailEnabledChanged)
    Q_PROPERTY(int detailStrength MEMBER detailStrength NOTIFY detailStrengthChanged)
    Q_PROPERTY(bool denoiseEnabled MEMBER denoiseEnabled NOTIFY denoiseEnabledChanged)
    Q_PROPERTY(int denoiseStrength MEMBER denoiseStrength NOTIFY denoiseStrengthChanged)
    Q_PROPERTY(bool debandEnabled MEMBER debandEnabled NOTIFY debandEnabledChanged)
    Q_PROPERTY(int debandStrength MEMBER debandStrength NOTIFY debandStrengthChanged)
...
signals:
    ...
    void vsrColorModeChanged();
    void detailEnabledChanged();
    void detailStrengthChanged();
    void denoiseEnabledChanged();
    void denoiseStrengthChanged();
    void debandEnabledChanged();
    void debandStrengthChanged();
