      ...
      m_VsrOverlaySelectedRow(0)
{
    ...
    m_SpecialKeyCombos[KeyComboToggleVsrOverlay].keyCombo = KeyComboToggleVsrOverlay;
    m_SpecialKeyCombos[KeyComboToggleVsrOverlay].keyCode = SDLK_g;
    m_SpecialKeyCombos[KeyComboToggleVsrOverlay].scanCode = SDL_SCANCODE_G;
